...
def listar_receitas():
    ...
    if client:
        ...
        df = _from_supabase_df(pd.DataFrame(data))
        return _ensure_columns(df, ["id", "data", "valor", "km", "tempo trabalhado", "observacao"])
...
def listar_despesas():
    ...
    if client:
        ...
        return _ensure_columns(df, ["id", "data", "categoria", "valor", "observacao"])
...
def listar_investimentos():
    ...
    if client:
        ...
        df = _from_supabase_df(pd.DataFrame(data))
        return _ensure_columns(df, ["id", "data", "aporte", "total aportado", "rendimento", "patrimonio total"])
