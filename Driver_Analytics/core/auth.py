...
def login_required() -> bool:
    ...
    with tab_register:
        ...
        pergunta = st.text_input("Pergunta secreta", key="cad_pergunta")
        resposta = st.text_input("Resposta secreta", type="password", key="cad_resposta")
    ...
    with tab_forgot:
        ...
        nascimento = st.date_input("Data de nascimento", key="rec_nasc")
