...
class DashboardServiceRulesTests(unittest.TestCase):
    ...
    def test_criar_investimento_recalcula_total_aportado(self):
        ...
        self.service.criar_investimento("2026-02-01", 100.0, 0.0, 5.0, 105.0)

        self.service.investimentos_repo.inserir.assert_called_once_with("2026-02-01", 100.0, 0.0, 5.0, 105.0)
    ...
    def test_criar_investimento_bloqueia_duplicado(self):
        ...
        with self.assertRaises(ValueError):
            self.service.criar_investimento("2026-02-10", 200.0, 0.0, 10.0, 1210.0)
    ...
    def test_atualizar_despesa_ignora_mesmo_id_no_duplicado(self):
        ...
        self.service.despesas_repo.atualizar.assert_called_once_with(5, "2026-02-07", "manutenção", 150.0, "")
    ...
    def test_atualizar_investimento_ignora_mesmo_id_no_duplicado(self):
        ...
        self.service.atualizar_investimento(8, "2026-02-11", 300.0, 0.0, 12.0, 2012.0)

        self.service.investimentos_repo.atualizar.assert_called_once_with(8, "2026-02-11", 300.0, 0.0, 12.0, 2012.0)
        self.service.investimentos_repo.recalcular_total_aportado.assert_called_once()
