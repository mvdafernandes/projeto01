...
def pagina_cadastros() -> None:
    ...
    with tab_investimentos:
        ...
        sub_aportes, sub_rendimentos = st.tabs(["Novo Aporte", "Patrimônio e Rendimentos"])
        ...
        with sub_aportes:
            ...
            with st.form("cad_invest_aporte_form"):
                ...
                patrimonio_total = st.number_input("Patrimônio total", min_value=0.0, key="cad_inv_aporte_patrimonio")
                    ...
                    if salvar:
                        if data_valida is None:
                            ...
                            _reset_fields([
                                ...
                                "cad_inv_aporte_categoria", "cad_inv_aporte_valor", "cad_inv_aporte_patrimonio",
                                "cad_inv_aporte_confirmar_exclusao", "cad_inv_aporte_rendimento_zero",
                            ])
                            st.rerun()
        ...
        with sub_rendimentos:
            st.caption("Atualize patrimônio total e rendimento em reais para cada recorte de tempo. Neste formulário o aporte é sempre zero.")
            ...
            with st.form("cad_invest_rendimento_form"):
                ...
                data_r = st.date_input("Data do recorte", key="cad_inv_rend_data")
                ...
                patrimonio_r = st.number_input("Patrimônio total", min_value=0.0, key="cad_inv_rend_patrimonio")
