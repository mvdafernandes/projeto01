...
def pagina_dashboard() -> None:
    ...
    km_nao_remunerado = service.metrics.km_nao_remunerado_total(df_receitas_f)
    km_remunerado_pct = service.metrics.km_remunerado_pct(df_receitas_f)
    km_nao_remunerado_pct = service.metrics.km_nao_remunerado_pct(df_receitas_f)
    litros_combustivel = service.metrics.litros_combustivel_total(df_despesas_negocio)
    consumo_km_l = service.metrics.consumo_medio_km_por_litro(df_receitas_f, df_despesas_negocio)
    ...
    with tab_cnpj:
        ...
        st.caption(
            "KM remunerado: quilometragem com receita. KM total rodado: valor informado no cadastro de receita. "
            "Consumo médio = KM total rodado / litros abastecidos (despesas de combustível)."
        )
        _render_kpi_grid(
            [
