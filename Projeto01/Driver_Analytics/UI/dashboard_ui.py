...
def pagina_dashboard() -> None:
    ...
    st.caption(
        "Micro (negócio): lucro e margem usam apenas despesas do negócio. "
        "Macro (global): despesas totais incluem negócio + pessoais."
    )
    ...
    kpis = [
        ...
        ("Despesa pessoal", format_currency(despesa_pessoal), None),
    ...
    render_kpi("Pontuação", score, "Baseado no desempenho do negócio (sem despesas pessoais)")
