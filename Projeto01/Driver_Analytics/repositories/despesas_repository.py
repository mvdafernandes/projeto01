...
class DespesasRepository(BaseRepository):
    ...
    table_name = "despesas"
    columns = ["id", "data", "categoria", "valor", "observacao", "tipo_despesa", "subcategoria_fixa", "esfera_despesa"]
    ...
    def inserir(
        ...
        cursor.execute(
            """
            INSERT INTO despesas (data, categoria, valor, observacao, tipo_despesa, subcategoria_fixa, esfera_despesa)
            VALUES (?, ?, ?, ?, ?, ?, ?)
            """,
            (
                model.data,
    ...
    def atualizar(
        ...
        cursor.execute(
            """
            UPDATE despesas
            SET data = ?, categoria = ?, valor = ?, observacao = ?, tipo_despesa = ?, subcategoria_fixa = ?, esfera_despesa = ?
            WHERE id = ?
            """,
            (
                model.data,
