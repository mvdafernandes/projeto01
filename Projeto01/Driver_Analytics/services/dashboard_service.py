...
class DashboardService:
    ...
    def criar_despesa(
        ...
        if tipo_ok == "VARIAVEL" and not subcat_ok:
            self.despesas_repo.inserir(data, categoria_ok, valor, observacao, esfera_despesa=esfera_ok)
        else:
    ...
    def atualizar_despesa(
        ...
        if tipo_ok == "VARIAVEL" and not subcat_ok:
            self.despesas_repo.atualizar(item_id, data, categoria_ok, valor, observacao, esfera_despesa=esfera_ok)
        else:
